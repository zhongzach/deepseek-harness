...
来源：[`packages/client/ui-chat/src/presentation-config.ts:5`](../packages/client/ui-chat/src/presentation-config.ts)
...
来源：[`packages/client/ui-conversation/src/index.ts:17`](../packages/client/ui-conversation/src/index.ts)
...
这些包作为库由其他包导入；`cordis.yml` 不能加载它们。
