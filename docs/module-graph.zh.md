...
flowchart TD
  ...
  subgraph group_api["packages/api"]
    ...
    pkg_api_operation_authorization["api-operation-authorization"]
  ...
  pkg_api_operation_authorization --> pkg_brand
  pkg_api_operation_authorization --> pkg_typert_protocol
  ...
  pkg_llm --> pkg_api_operation_authorization
  pkg_session --> pkg_scope
  pkg_api_remotes --> pkg_api_operation_authorization
  ...
  pkg_api_settings_controller --> pkg_api_operation_authorization
  ...
  pkg_api_session_controller --> pkg_api_operation_authorization
...
| [`api-operation-authorization`](../packages/api/operation-authorization) | `api` | [`brand`](../packages/util/brand), [`typert-protocol`](../packages/typert/protocol) |
...
| [`llm`](../packages/llm/llm) | `llm` | [`api-operation-authorization`](../packages/api/operation-authorization) |
| [`session`](../packages/core/session) | `core` | [`scope`](../packages/core/scope) |
| [`api-remotes`](../packages/api/remotes) | `api` | [`api-operation-authorization`](../packages/api/operation-authorization), [`scope`](../packages/core/scope) |
...
| [`api-settings-controller`](../packages/api/settings-controller) | `api` | [`agent-presets`](../packages/preset/agent-presets), [`api-operation-authorization`](../packages/api/operation-authorization), [`credentials`](../packages/credentials/credentials), [`native-command`](../packages/util/native-command), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`typert-protocol`](../packages/typert/protocol) |
