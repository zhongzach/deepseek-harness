...
For incomplete model output, `agent/output-limit` offers an optional recovery callback after durable retention. Its retry requires changed, logged model context; the [core reference](../../../docs/subsystems/core.md#the-agent-handle) defines cancellation and ownership.
