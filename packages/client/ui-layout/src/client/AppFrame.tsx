...
export type AppFrameProps =
  & PropsRuntime<'root'>
  & PropsRenderSlots<'sidebar' | 'main' | 'shelf' | 'rightbar' | 'shell.overlay' | 'titlebar'>
...
export function AppFrame({
  ...
  const normal = computeColumns(viewport, !layoutInfo.rightbarShown && narrow ? 0 : sidebarPreference, rightbarPreference, layoutInfo.shelf)
  const cols = computeColumns(viewport, sidebarPreference, layoutInfo.rightbarTrack ? rightbarPreference : 0, layoutInfo.shelf)
  ...
  return (
    <div className={css.shell}>
      ...
      <div
        ...
        style={{
          gridTemplateColumns:
            `${cols.sidebar}px minmax(0, 1fr) ${cols.shelf}px ${cols.rightbar}px`,
        }}
