...
describe('DocumentTitle', () => {
  ...
  it('projects the shell-resolved product title', () => {
    const mounted = render(<DocumentTitle title="第一章" productTitle="WriterX Hermes" />)
    expect(document.title).toBe('第一章 — WriterX Hermes')
    mounted.rerender(<DocumentTitle productTitle="WriterX Hermes" />)
