...
describe('ui-layout client apply', () => {
  ...
  it('provides ctx.layout and declares the official frame slots and product shelf/titlebar slots', async () => {
  ...
  it('shares a pre-created instance between service actions, root rendering, and panelInfo', async () => {
    ...
    layout.openShelf()
    expect(instance.getSnapshot().layoutInfo.shelf).toBe(300)
