...
export const zh = {
  ...
  'diagnostic.unsupported': '协作助手记录版本不受支持',
  ...
  'loading.label': '正在加载协作助手…',
  'loading.aria': '正在加载协作助手',
  'load.error': '无法加载协作助手',
  'retry': '重试',
  'mode.oneShot': '一次性',
  ...
  'branch.collapse': '收起 {label} 的下级协作助手',
  'branch.expand': '展开 {label} 的下级协作助手',
  'count.total.one': '{count} 个协作助手',
  'count.total.other': '{count} 个协作助手',
  'count.running.one': '{count} 个协作助手，正在运行',
  'count.running.other': '{count} 个协作助手，正在运行',
  'switcher.aria': '切换协作助手：{title}',
  'tree.aria': '协作助手会话',
