...
export function WorkspaceBrowser({
  ...
  return (
    <div className={clsx(css.root, !wide && css.rail)}>
      ...
      {renderSlot('sidebar.workspaces.rename', {
        // The hole's contract predates the stored/display title split: the
        // occupant seeds its dialog with the row's current display title.
        target: renameTarget === null
          ? null
          : {
            workspaceId: renameTarget.workspaceId,
            currentTitle: workspaces.find(w => w.workspaceId === renameTarget.workspaceId)?.title ?? renameTarget.storedTitle,
          },
        onClose: closeRename,
      }, { fallback: <Modal
