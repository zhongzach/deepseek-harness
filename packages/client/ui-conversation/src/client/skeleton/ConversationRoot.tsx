...
import { HeroGlow, HeroHeadline, HeroShell, WorkspaceChip, workspaceLabel } from './EmptyHero.tsx'
    ...
    <div className={clsx(css.composerStack, hero && css.composerHero)}>
      ...
      {hero && (
        <HeroShell
          ...
          headline={renderSlot('conversation.hero.headline', {}, { fallback: <HeroHeadline t={t} renderSlot={renderSlot} /> })}
        />
      )}
