...
describe('ReferenceChip', () => {
  ...
  it('renders the product file marker without changing the supplied label', () => {
    const { container } = render(<ReferenceChip label="chapter.md" marker="#" invalid={false} />)
    expect(container.textContent).toBe('#chapter.md')
  })
