...
/** Host-backed metric visibility injected by the Chat renderer registration. */
export interface TurnTailMetricsInjected {
  hooks: {
    /** False until Host settings arrive, then the resolved presentation preference. */
    showTurnMetrics: ObservableSnapshot<boolean>
  }
}

type TurnTailNodeViewProps = ChatNodeViewProps<'turn-tail'>
  & PropsRenderSlots<'conversation.chat.turnTail' | 'conversation.chat.assistant-actions'>
  & InjectFace<TurnTailMetricsInjected>
