...
export const zh = {
  ...
  'message.turnProcess.deepDivingFor': '正在深入思考，用时{duration}',
  ...
  'message.contextInjection': '已载入写作环境',
  ...
  'message.turnProcess.subagents.one': '{count} 个协作助手',
  'message.turnProcess.subagents.other': '{count} 个协作助手',
