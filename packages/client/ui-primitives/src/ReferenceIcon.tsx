...
import { ICON_MEDIUM_STROKE, ICON_REGULAR_STROKE, IconSkillOutlineMedium, IconSkillOutlineRegular } from './icons/index.tsx'
...
function ReferenceIconArtwork({ kind, size = 16, className, strokeWidth }: WeightedReferenceIconProps): ReactNode {
  switch (kind) {
    ...
    case 'skill': return strokeWidth === ICON_MEDIUM_STROKE
      ? <IconSkillOutlineMedium size={size} className={className} />
      : <IconSkillOutlineRegular size={size} className={className} />
  }
}
