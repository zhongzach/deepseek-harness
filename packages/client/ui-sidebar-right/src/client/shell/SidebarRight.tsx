...
import { canSplit, dockPaneIds, DockLayout, findPaneContentTab, getPane, getTab } from '@deepseek-ai/dsh-client-ui-dockkit'
    ...
    >
      <div className={css.panelBody}>
        <DockLayout
          ...
          active={panel.active}
          keepMounted={tab => definitions.find(type => type.kind === tab.kind)?.keepMounted === true}
...
export function RightbarSeat({
  ...
  useEffect(() => {
    if (active) actions.open(sessionId)
  }, [actions, sessionId, active, retainedKind])
  ...
  const panel: PanelProps = {
    ...
    fullscreen, exitFullscreen, reportRoom, retainedKind, active, retainTab, shortcuts, splitPane, toggleFullscreen,
  }
