...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('operation-denied'), message: z.string(), details: z.object({
    reasonCode: z.string(), retryable: z.literal(false), reasonDetails: z.record(z.string(), z.unknown()).optional(),
  }) }),
