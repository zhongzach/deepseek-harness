...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'Authorize a call before persistence, selection or discovery.',
    description: 'Authorize a call before persistence, selection or discovery.',
    parameters: [{ name: 'operation', description: 'detached non-secret request metadata.' }],
  },
  {
    name: 'api/model-catalog',
    mode: 'serial',
    signature: '\'api/model-catalog\'(catalog: ApiModelCatalog): void | Promise<void>',
    summary: 'Decorate or restrict catalog rows without changing provider routing.',
    description: 'Decorate or restrict catalog rows without changing provider routing.',
    parameters: [{ name: 'catalog', description: 'mutable, detached presentation catalog.' }],
  },
  {
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ApiCatalogModel',
    declaration: 'export interface ApiCatalogModel {\n    id: string;\n    name: string;\n    description?: string;\n    presentation?: ModelCatalogPresentation;\n    availability?: ModelAvailability;\n}',
  },
  {
    name: 'ApiKeyRecord',
  ...
  {
    name: 'AppendIntent',
    declaration: 'export interface AppendIntent {\n    ignorable?: true;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface ModelAvailability {\n    selectable: boolean;\n    reason?: string;\n    action?: ModelAvailabilityAction;\n}',
  },
  {
    name: 'ModelCatalog',
  ...
  },
  {
    ...
    declaration: 'export interface ModelCatalogPresentation {\n    sectionId: string;\n    sectionName: string;\n    sectionOrder?: number;\n}',
  },
  {
