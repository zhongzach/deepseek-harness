...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.chat.context.presentation',
    kind: 'chain',
    scope: 'session',
    summary: 'Conditional product rendering of a context producer, with the standard row as fallback.',
    doc: 'Conditional product rendering of a context producer, with the standard row as fallback.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.chat.context.presentation\', () => ctx.slots.register(\n      { name: \'conversation.chat.context.presentation\', select: owner => null },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Product-owned replacement for the complete blank-session headline.',
    doc: 'Product-owned replacement for the complete blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Product launcher with current-selection-safe input actions.',
    doc: 'Product launcher with current-selection-safe input actions.',
    registerOptions: [],
    ownerProps: [
  ...
  {
    key: 'conversation.message.user-text',
    kind: 'chain',
    scope: 'session',
    summary: 'Optional user-text presentation.',
    doc: 'Optional user-text presentation. Attachments, action copy and durable messages retain their original ownership.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.message.user-text\', () => ctx.slots.register(\n      { name: \'conversation.message.user-text\', select: owner => null },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:316',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:83',
  },
  {
  ...
  },
  {
    ...
    kind: 'keyed',
    scope: 'root',
    summary: 'Optional decorative navigation icon, keyed by a settings.section id.',
    doc: 'Optional decorative navigation icon, keyed by a settings.section id.\nThe shell supplies the size and falls back to its standard section\nglyph when the key has no contribution.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shelf\', () => ctx.slots.register(\n      { name: \'shelf\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'A full-width bar above the columns — the seat for a downstream composition\'s window chrome (brand, window controls\' drag region, frame-level actions) when the app runs in a frameless shell.',
    doc: 'A full-width bar above the columns — the seat for a downstream\ncomposition\'s window chrome (brand, window controls\' drag region,\nframe-level actions) when the app runs in a frameless shell. Empty by\ndefault: the row takes no height until something registers, so the\nshipped GUI is unchanged. Root scope; no owner props.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'titlebar\', () => ctx.slots.register(\n      { name: \'titlebar\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
